...
/// [Navigator.pop].
class ZeroTimePickerDialog extends StatefulWidget {
  ...
  /// Restoration ID to save and restore the state of the [ZeroTimePickerDialog].
  ///
...
class _ZeroTimePickerDialogState extends State<ZeroTimePickerDialog>
    with RestorationMixin {
